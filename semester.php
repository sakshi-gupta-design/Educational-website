	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">semesters </h4>
				   <h4 class="box-link"><a href="semesters.php">Add semesters</a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='semesters.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
