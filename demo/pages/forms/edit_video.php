                ...
                <div class="mdc-card">
                  ...
                  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input type="text" id="title" name="title" class="mdc-text-field__input" value="<?php echo $result['title'];?>">
                ...
                <div class="mdc-card">
                  ...
                  <div class="template-demo">
                    <div class="mdc-layout-grid__inner">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input  type="file" id="myFile" name="video" class="mdc-text-field__input" value="<?php echo $result['video'];?>">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                         <select id="status" name="status" class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $result['status'];?>">
